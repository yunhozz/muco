...
public class WebClientConfig {
    ...
    public static WebClient commonWebClient(
    ...
    public static HttpClient defaultHttpClient(@Qualifier(value = WEB_CLIENT_CONNECTION_PROVIDER) ConnectionProvider provider) {
